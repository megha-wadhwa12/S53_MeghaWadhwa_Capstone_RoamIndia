        ...
        return (
          <>
            <div>
              ...
              <img src={LayerBlur} alt="" className='relative h-[55vh] w-[100vw] top-5 filter opacity-80 blur-lg drop-shadow-md brightness-90' />
            </div>
            <div className='flex justify-center w-full h-full absolute mt-[-30vh]'>
              <div className='w-10/12 h-full rounded-lg bg-white mb-16 '>
                <div className='flex'>
            ...
            <div className='mt-[50vh] ml-12'>
              <div role="tablist" className="tabs tabs-bordered w-full">
                ...
                <input type="radio" name="my_tabs_1" role="tab" className="tab space-x-4 font-navbar text-3xl text-[#0088B3] h-[10vh]" aria-label="Photos" />
